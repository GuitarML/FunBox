...
namespace CloudSeed
{
	...
	public:
		...
		void initFactoryChorus()
		{
			...
			//parameters[(int)Parameter2::LineCount] = 0.0;                          // Modified to work with Terrarium switch implementation
		...
		void initFactory90sAreBack()
		{
			...
			parameters[(int)Parameter2::LowShelfEnabled] = 1;
			parameters[(int)Parameter2::HighShelfEnabled] = 1;
			parameters[(int)Parameter2::CutoffEnabled] = 1;
