...
#define DEFAULT_SRATE 96000.0 // KAB CHANGE
...
void ReverbSc96::NextRandomLineseg(ReverbSc96Dl *lp, int n)
{
...
int ReverbSc96::InitDelayLine(ReverbSc96Dl *lp, int n)
{
    float read_pos;
    /* int     i; */
...
int ReverbSc96::Process(const float &in1,
                      const float &in2,
                      float *      out1,
                      float *      out2)
{
