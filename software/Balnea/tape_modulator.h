...
class TapeModulator {
    public:
        ...
        */
        ...
        float GetTapeSpeedLeft() const;

        float GetTapeSpeedRight() const;
        ...
        /** Generates tape speed variation based on wow and flutter parameters.
            ...
            \param right_rate_ratio - ratio between left/right stereo rates. For example, 2 would be twice as fast on right, 0.5 half, etc.
            \return Speed variation value based on combined modulation sources
        */
        void ProcessTapeSpeed(float wow_rate, float flutter_rate, float wow_depth, float flutter_depth, float right_rate_ratio);
    ...
    private:
        ...
        float t_wow_right_ = 0.7; 
        float t_flutter_right_ = 0.7;
