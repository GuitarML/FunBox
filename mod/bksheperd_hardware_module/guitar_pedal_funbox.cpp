...
void GuitarPedalFunbox::Init(bool boost)
{
    ...
    Pin knobPins[] = {seed::D16, seed::D17, seed::D18, seed::D19, seed::D20, seed::D21, seed::D15}; // seed::D15, the 7th knobPin is for Expression pedal input
    InitKnobs(7, knobPins);

    // Index reference: {0:footswitch1, 1:footswitch2, 2:Switch1Left, 3:Switch1Right, 4:Switch1Left, 5:Switch2Right, 6:Switch3Left, 7:Switch3Right, 8:Dip1, 9:Dip2, 10:Dip3, 11:Dip4}
    Pin switchPins[] = {seed::D26, seed::D25, seed::D14, seed::D13, seed::D7, seed::D10, seed::D2, seed::D4, seed::D1, seed::D3, seed::D5, seed::D6};
